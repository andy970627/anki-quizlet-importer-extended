> **這是 Better Lyrics 的非官方 fork（unofficial fork），不是官方版本。**
> 這個 fork 加了「歌詞節奏模式」：一個跟著同步歌詞出現音符的 osu 風格小遊戲。
> 改了哪些地方、怎麼建置與安裝，請看 [FORK.md](FORK.md)。原專案：<https://github.com/better-lyrics/better-lyrics>（GPL-3.0）。
> 以下是原專案的 README，內容未修改；有問題請回報到這個 fork，不要回報給原作者。
